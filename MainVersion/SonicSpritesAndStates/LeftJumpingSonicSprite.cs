...
//Draws Sonic's left jumping sprite

namespace NotSonicGame
{
    internal class LeftJumpingSonicSprite : ISprite
    {
        ...
        public LeftJumpingSonicSprite(Sonic sonic)
        {
            this.sonic = sonic;
            SonicSpriteSheet = AssetStorage.SonicSpriteSheet;
            sourceRectangle = SonicUtility.LeftJumpingRectangle;
