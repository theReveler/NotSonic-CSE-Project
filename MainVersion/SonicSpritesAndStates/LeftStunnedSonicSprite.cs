...
{
    class LeftStunnedSonicSprite : ISprite
    {
        ...
        public LeftStunnedSonicSprite(Sonic sonic)
        {
            this.sonic = sonic;
            SonicSpriteSheet = AssetStorage.SonicSpriteSheet;
            sourceRectangle = new Rectangle(192, 5, 40, 35);
        ...
        {
            return new Rectangle((int)sonic.Position.X + 5, (int)sonic.Position.Y + 5, 40, 35);
        }
    }
}