...
{
    class LeftFacingAttackBuzzBomberSprite : IEnemySprite
    {
        ...
        public LeftFacingAttackBuzzBomberSprite()
        {
            enemySpriteSheet = AssetStorage.EnemySpriteSheet;
            currentFrame = LeftFacingAttackBuzzBomberSpriteStartFrame;
            endFrame = LeftFacingAttackBuzzBomberSpriteEndFrame;
